...
#pragma warning disable 1066,1570,1573,1591
    ...
    public class ConventionMapper : IMapper
    {
        ...
        public ConventionMapper()
        {
            ...
            MapTable = (ti, t) =>
            {
                var tableName = t.GetCustomAttributes(typeof(TableAttribute), true).FirstOrDefault() as TableAttribute;
    ...
    public class TableInfo
    {
        ...
        public static TableInfo FromPoco(Type t)
        {
            ...
            ti.TableName = a.Length == 0 ? t.Name : (a[0] as TableAttribute).Name;
